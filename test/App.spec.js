...
xdescribe('<Search />', () => {
  ...
  it('should render as many shows as there are data for', () => {
      const wrapper = shallow(<Search />)
      console.log('wrapper', Array.isArray(wrapper))
  ...
  it('should filter correctly given new state', () => {
    ...
    console.log('wrapper.find', wrapper.find('.show-card'));
...
describe('Store', () => {
  ...
  it('should handle setSearchTerm actions', () => {
    const state = rootReducer({ searchTerm: 'some random string' }, { type: 'setSearchTerm', 
